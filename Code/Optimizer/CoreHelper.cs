...
namespace Optimizer {
    internal static class CoreHelper {
        internal readonly static string CoreFolder = CleanHelper.ProgramData + "\\RGBTool\\";
        internal readonly static string ReadyMadeMenusFolder = CleanHelper.ProgramData + "\\RGBTool\\ReadyMadeMenus\\";
        internal readonly static string ScriptsFolder = CleanHelper.ProgramData + "\\RGBTool\\Required\\";
        internal readonly static string ExtractedIconsFolder = CleanHelper.ProgramData + "\\RGBTool\\ExtractedIcons\\";
        internal readonly static string FavIconsFolder = CleanHelper.ProgramData + "\\RGBTool\\FavIcons\\";
        internal readonly static string StartupItemsBackupFolder = CleanHelper.ProgramData + "\\RGBTool\\StartupBackup\\";
