...
namespace Optimizer
{
    partial class FirstRunForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// pictureBox87
			// 
			this.pictureBox87.Image = global::Optimizer.Properties.Resources.vietnam;
			...
			this.btnStart.Location = new System.Drawing.Point(11, 65);
			this.btnStart.Margin = new System.Windows.Forms.Padding(2);
			this.btnStart.Name = "btnStart";
			this.btnStart.Size = new System.Drawing.Size(315, 31);
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::Optimizer.Properties.Resources.vietnam;
			...
			this.radioTurkish.Size = new System.Drawing.Size(116, 25);
			this.radioTurkish.TabIndex = 88;
			this.radioTurkish.Tag = "";
			this.radioTurkish.Text = "VietNamese";
			...
			this.radioRussian.Size = new System.Drawing.Size(113, 25);
			this.radioRussian.TabIndex = 79;
			this.radioRussian.Tag = "themeable";
			this.radioRussian.Text = "Vietnamese";
			...
			this.radioPolish.Visible = false;
			...
			this.radioArabic.Visible = false;
			...
			this.radioKurdish.Visible = false;
			...
			this.radioHungarian.Visible = false;
			...
			this.radioRomanian.Visible = false;
			...
			this.radioJapanese.Visible = false;
			...
			this.radioNepali.Visible = false;
			...
			this.radioUkrainian.Visible = false;
			...
			this.radioBulgarian.Visible = false;
